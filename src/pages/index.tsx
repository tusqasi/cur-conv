...
const Home: React.FC<{ conversion_table: any }> = ({ conversion_table }) => {
	...
	return <>
		...
		<div className="  flex flex-col   w-screen h-screen items-center   justify-center  p-4  bg-white ">
			<div className={`logo-container ${isVisible ? 'slide-in' : ''}   transition-transform scale-100 hover:scale-110   `}>
